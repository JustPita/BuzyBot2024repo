    ...
    <main class="max-w-3xl mx-auto mt-8 mb-20 p-4">
        <?php
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<li>" . $row['ipportier'] . " - Emplacement : " . $row['idlocal'] . " - Camera : " . $cameraStatus . " " ." <a href='javascript:void(0)' class='text-red-500 ml-2' onclick='confirmDelete(" . $row['idportier'] . ")'>Supprimer</a></li>";
            }
            echo "</ul>";
        ...
        <form action="" method="post" class="flex flex-col items-center mt-4">
            ...
            <button type="submit" name="addPortier" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue active:bg-blue-800 transition duration-150 ease-in-out w-full">Ajouter Portier</button>
        </form>
        <p>
